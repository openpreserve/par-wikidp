...
def format_families_get(file_format_guid=None, file_format_name=None, guid=None, name=None, modified_after=None, modified_before=None, offset=None, limit=None):  # noqa: E501
    ...
    Returns an array of Format Families that match all of the filter conditions supplied. Any number of filters can be used together. The date filters should be supplied as ISO-8601 date times or dates, i.e. yyyy-MM-ddThh:mm:ss.SZ or yyyy-MM-dd. If no time information is supplied, then 00:00:00 in UTC will be assumed. This means that if you supply modified-after and modified-before dates of 2019-01-01 and 2019-12-31, you will not match any Format Families modified during the day of 31st December. # noqa: E501

    :param file_format_guid: A comma separated list of guids of file formats (i.e. fmt/1, x-fmt/2. This filter matches only those Format Families that include any of the specified formats.
    :type file_format_guid: str
    :param file_format_name: A comma separated list of names of file formats. This filter matches only those Format Families that include any of the specified formats.
    :type file_format_name: str
    :param guid: A comma separated list of GUIDs of Format Families. This filter matches only those Format Families that are identified by one of the listed GUIDs.
    :type guid: str
    :param name: A comma separated list of names of Format Families. This filter matches only those Format Families that are identified by one of the listed names.
    :type name: str
    :param modified_after: This filter matches only those Format Families whose local last modified date is after the specified date.
    :type modified_after: str
    :param modified_before: This filter matches only those Format Families whose local last modified date is before the specified date.
    :type modified_before: str
    :param offset: Used for requesting paged responses, this defines the offset of the first Format Family to return from the start of the list of all matching Format Families.
    :type offset: int
    :param limit: Used for requesting paged responses, this defines the maximum number of Format Families to return.
    :type limit: int
...
def format_families_guid_put(guid, Authorization, body=None):  # noqa: E501
    ...
    Updates the Format Family specified by the GUID of the PAR Identifier and returns the family as updated. # noqa: E501
